...
from config import NUMBER_OF_SAMPLES_TO_LOAD, PATH_TO_IMAGES
from core.builders.data_augmentation import (
    Normalize,
    RandomCrop,
...
class FlyingChairsDataGenerator(Sequence):
    ...
    def __getitem__(self, index):
        ...
        for i in range(start_index, end_index):
            ...
            img_pair = [np.array(Image.open(os.path.join(PATH_TO_IMAGES

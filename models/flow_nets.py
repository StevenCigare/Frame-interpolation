...
class FlowNet:
    ...
    def create_model(self):
        ...
        predict3 = Conv2D(filters=2, kernel_size=3, strides=(1, 1), padding='same',
        ...
        predict2 = Conv2D(filters=2, kernel_size=3, strides=(1, 1), padding='same',
        ...
        predict1 = Conv2D(filters=2, kernel_size=3, strides=(1, 1), padding='same',
